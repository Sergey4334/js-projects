...
(function (arrOfTasks) {
  //* Преобоазовать масив обьектов в обьект обьектов. 
  const objOfTasks = arrOfTasks.reduce((acc, task) => {
    acc[task._id] = task;
    return acc;
  }, {});

  //* Темы для ToDO Project
  ...
  //* Добавляем наш fragment в UL // Element UI
  ...
  themSelect.addEventListener('change', onThemeSelectHandler);
